    ...
    <div className="min-h-screen bg-background">
      ...
      <nav className="border-b border-border px-6 py-4">
        <div className="mx-auto flex max-w-7xl items-center justify-between">
          ...
          <div className="hidden items-center gap-8 md:flex">
            ...
            <Button onClick={() => navigate("/onboarding/gender")}>
              Start Free Trial
            </Button>
          </div>
        </div>
          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="mb-8 text-xl text-muted-foreground">
                Cal AI creates personalized meal plans and tracks your calories effortlessly
              </p>
              <Button
                size="lg"
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-5xl">
          <div className="rounded-3xl bg-gradient-to-r from-accent to-accent/80 p-12 text-center text-background">
            ...
            <p className="mb-8 text-xl opacity-90">1000+ Cal AI people trust us</p>
      ...
      <section className="px-6 py-20">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mb-8 text-xl text-muted-foreground">
            Join thousands of people achieving their health goals with Cal AI
          </p>
      ...
      <footer className="border-t border-border px-6 py-8">
        <div className="mx-auto max-w-7xl text-center text-muted-foreground">
          <p>© 2025 Cal AI. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
